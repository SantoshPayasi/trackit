...
-- AddForeignKey
ALTER TABLE "TaskAssignement" ADD CONSTRAINT "TaskAssignement_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TaskAssignement" ADD CONSTRAINT "TaskAssignement_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES "Task"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
